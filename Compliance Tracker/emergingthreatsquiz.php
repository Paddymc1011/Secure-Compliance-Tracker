...
// This page shows only Emerging Threats quizzes
$category = 'emerging';
...
if ($hasQuiz && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($submissionStmt->execute()) {
        ...
        echo "<!DOCTYPE html>\n";
        echo "<html>\n<head>\n<meta charset=\"utf-8\">\n<title>Emerging Threats Quiz - Blockchain Verification</title>\n";
    ...
    echo "<h2>Emerging Threats Quiz Submitted Successfully</h2>\n";
    ...
    echo "        : null;\n";
    echo "      if (!provider) {\n";
    echo "        alert('Backpack wallet not found. Please install/enable Backpack and reload this page.');\n";
    echo "        return;\n";
    echo "      }\n";
    ...
    echo "        // Try to confirm the transaction; if this fails due to block height being exceeded or timeout,\n";
    echo "        // log the error but still proceed to save the reference in the database.\n";
    echo "        try {\n";
...
<html>
<head>
    <title>Emerging Threats Quiz</title>
    <style>
        body {
            font-family: Arial;
