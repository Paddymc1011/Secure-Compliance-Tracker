...
// This page shows only IoT Attacks quizzes
$category = 'iot';
...
if ($hasQuiz && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($submissionStmt->execute()) {
        ...
        echo "<!DOCTYPE html>\n";
        echo "<html>\n<head>\n<meta charset=\"utf-8\">\n<title>IoT Attacks Quiz - Blockchain Verification</title>\n";
    ...
    echo "<h2>IoT Attacks Quiz Submitted Successfully</h2>\n";
    ...
    echo "        // Try to confirm the transaction; if confirmation fails due to block height or timeout,\n";
    echo "        // log the error but still continue with saving the reference in the database.\n";
    echo "        try {\n";
